...
# if you can to compare one video one make the list l_videos_gt with one item 
...
for i in range(len(l_videos_gt)):
    vid_name=l_videos_gt[i][:-7]                            # get video name
...
# save df as xlsx
df.to_excel('compare_RAI_gt_rqa_e15_res.xlsx', index=False) 
